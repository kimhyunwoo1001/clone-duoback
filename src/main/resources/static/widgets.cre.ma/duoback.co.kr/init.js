  ...
  i[g].init = function(username, user_name){
    ...
    if(domain_prefix){
      if(domain_prefix !== ""){
        ...
        a = s.createElement(o);
        a.src = "http://" + domain_prefix + "widgets.cre.ma/duoback.co.kr/init.js";
        a.async = 1;
        a.id = "crema-jssdk";
...
r = s.createElement(o);
r.async = 1;
r.src = "http://assets3.cre.ma/widgets/assets/pc-85390ca2609a8d7e8b6509efd77fdad7a85d0cc5da0c43fc9cd671cf13110c7f.js";
r.id = "crema-jssdk";
r.charset = "UTF-8";
