  ...
  i[g].init = function(username, user_name){
    ...
    if(domain_prefix){
      if(domain_prefix !== ""){
        ...
        a = s.createElement(o);
        a.src = "http://" + domain_prefix + "widgets.cre.ma/duoback.co.kr/mobile/init.js";
        a.async = 1;
        a.id = "crema-jssdk";
...
i[g].info = {
  ...
  ad_base_url: "http://ad.cre.ma/duoback.co.kr",
  widgets_base_url: "http://widgets.cre.ma",
  review_api_base_url: "http://review-api3.cre.ma",
...
r = s.createElement(o);
r.async = 1;
r.src = "http://assets3.cre.ma/widgets/assets/mobile-8494177b36d83804bc7e2a145482229faf2e4a7e5917bd3bb79c5e4e753906d8.js";
r.id = "crema-jssdk";
r.charset = "UTF-8";
